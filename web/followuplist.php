...
if (isset($_GET['code']) && isset($_GET['id'])) {
	...
	if (mysql_num_rows(mysql_query($query)) > 0) {
		...
		echo "<BR>";
		echo "To see the list of all the follow up projects follow <A HREF='$publicRoot".$_GET['lang']."/page-8'>this link</A>";
	} else {
		echo "An error occured.. Could not confirm the code for your follow up of TheColorOrange.. Please goto <A HREF='$publicRoot".$_GET['lang']."/page-9'>this page</A> and try again...<BR><BR>";
