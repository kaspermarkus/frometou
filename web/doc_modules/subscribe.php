...
if (isset($_POST['submit'])) {
	...
	if ($errormsg != "") {
		...
		if ($_POST['support_check'] == "true") {
			...
			$message .= "\tThank you for showing your support for the Color Orange. Please confirm that you want to have your name on the list of supporters by clicking <A HREF='$publicRoot".$_GET['lang']."/page-2?id=".$row['sid']."&code=".$row['time']."'>this link</A><BR>\r\n";
